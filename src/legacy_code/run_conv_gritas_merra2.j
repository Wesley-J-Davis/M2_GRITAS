...
# -------------------------------------------------
# changed the wall clock time from 6 hrs to 10 hrs
# on May 3, 2024 as the job stopped for M09D09 due
# to wall clock time over limit
# -------------------------------------------------
...
setenv RootDir  /discover/nobackup/projects/gmao/merra2/data/obs/.WORK/src/GrITAS-MERRA2_V2_SLES12/GrITAS
...
#set MONTH_TABLE = ( 01 )
#set MONTH_TABLE = ( 02 03 04 05 )
#set MONTH_TABLE = ( 06 07 08 09 )
#set MONTH_TABLE = ( 10 11 12 )
#set MONTH_TABLE = ( 12 )
#set MONTH_TABLE = ( 04 05 06 )
# Note: M06 was not somehow processed
# -----------------------------------
##set MONTH_TABLE = ( 06 07 08 09 )
...
# Following is for missing Dec 2018 day 17 onward
# -----------------------------------------------
##   set Day0 = 17 
# -----------------------------------------------
